...
<div class="container">
  <form id="create_event">
    ...
    <div class="form-group">
      ...
      <input type="phone" class="form-control" value="{{$data->phone}}" id="phone" placeholder="Enter Phone Number" name="phone">
    </div>
          ...
          $.ajax({
            ...
            success: function(obj) {
              ...
              if(obj.status ="success") {
                swal({
                    title:'form Update <b style="color:green;">successfully</b>!',
                    type:'success',
